...
class ParkingApp:
    def __init__(self):
        ...
        self.form_file = "form.ui"
        self.login_file = "login.ui"
        self.dashboard_file = "ParkingDashboard.ui"
        self.signup_file = "signup.ui"
        ...
        self.dashboard_window.findParkingButton.clicked.connect(self.find_parking_spot)
